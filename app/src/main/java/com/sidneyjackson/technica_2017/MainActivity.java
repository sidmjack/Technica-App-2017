...
public class MainActivity extends AppCompatActivity
    ...
    private static ContactsFragment contactsFragment = new ContactsFragment();
    ...
    private static int currentTitle = R.string.home_title;
    private static Fragment currentFragment = homeFragment;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case (R.id.home):
                ...
                currentTitle = R.string.home_title;
                break;
            case (R.id.connect):
                currentFragment = contactsFragment;
                currentTitle = R.string.connect_title;
                break;
            case (R.id.profile):
                currentFragment = profileFragment;
                currentTitle = R.string.profile_title;
                break;
            default:
                currentFragment = homeFragment;
                currentTitle = R.string.home_title;
